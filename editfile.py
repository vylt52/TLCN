...
cap = cv2.VideoCapture("D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/Videos/main.mp4")  # For video

model = YOLO(r"D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/best_new/best.pt")  # large model works better with the GPU
