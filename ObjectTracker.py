...
def video_detect_helmet(path_x):
    ...
    dataBienBan_XEMAYVIPHAMBAOHIEM = 'D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/BienBanNopPhatXeMayViPhamMuBaoHiem/ '
                        ...
                        if 0 < center_x < int(frame.shape[1]) and int((2 * frame.shape[0]) / 10) < center_y < int(
                            ...
                            if filterData and id not in array_helmet_filter:
                                ...
                                createBB_helmet.bienBanNopPhat(examBB,
                                                               temp_image.name,
                                                               "D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/data_xe_vp_bh/ " + str(
                                                                   id) + '.jpg',
                                                               stt_BB_CTB)
                                temp_image.close()
                            # draw_text(frame, text + " warning", font_scale=0.5,
...
if __name__ == '__main__':
    video_detect_helmet("D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/Videos/test11.mp4")
