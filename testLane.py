...
def imageMotorViolate(frame, r1, r2, c1, c2, stt):
    ...
    data_xe_may_vi_pham = "D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/data_xe_may_vi_pham/ " + nameFile
...
def imageCTBViolate(frame, r1, r2, c1, c2, stt):
    ...
    cropped_region = frame[r1:r2, c1:c2]
    nameFile = str(stt) + '.jpg'
    data_xe_may_vi_pham = "D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/data_oto_vi_pham/ " + nameFile
    # Lưu vùng đã cắt vào tệp tin
    cv2.imwrite(data_xe_may_vi_pham, cropped_region)
...
def imageViolateHelmet(frame, r1, r2, c1, c2, stt):
    ...
    cropped_region = frame[r1:r2, c1:c2]
    nameFile = str(stt) + '.jpg'
    data_xe_may_vi_pham = "D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/data_xe_vp_bh/ " + nameFile
    # Lưu vùng đã cắt vào tệp tin
    cv2.imwrite(data_xe_may_vi_pham, cropped_region)
...
if __name__ == '__main__':
    cap = cv2.VideoCapture("D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/Videos/main.mp4")
    model = YOLO('YolWeights/best.pt')
    stt_m = 0
    stt_ctb = 0
    examBB = createBB.infoObject()
    dataBienBan_M = 'D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/BienBanNopPhatXeMay/ '
    dataBienBan_CTB = 'D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/BienBanNopPhatXeOTo/ '
                            ...
                            if canh_bao_vi_pham_lane_oto:
                                ...
                                if filterData:
                                    ...
                                    createBB.bienBanNopPhat(examBB,
                                                            temp_image.name,
                                                            "D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/data_xe_may_vi_pham/ " + str(
                                                                stt_m) + '.jpg',
                                                            stt_BB_m)
                                    temp_image.close()
                        ...
                        if box.cls[0] == 0 or box.cls[0] == 3 or box.cls[0] == 4:
                            if canh_bao_vi_pham_lane_xe_may:
                                ...
                                if filterData:
                                    ...
                                    createBB.bienBanNopPhat(examBB,
                                                            temp_image.name,
                                                            "D:/HK1 NAM 4/TLCN/YOLOv8-Traffic-Monitoring-Systems-main/python_project/data_oto_vi_pham/ " + str(
                                                                stt_ctb) + '.jpg',
                                                            stt_BB_CTB)
                                    temp_image.close()
                            else:
